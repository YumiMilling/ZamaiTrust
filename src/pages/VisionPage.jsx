      ...
      <div className="sec-eg">
        <div className="inner">
          ...
          <p className="p" style={{ color: 'rgba(242,237,230,.55)', fontSize: 14, marginTop: 8 }}>
            Six primitives. One data model. Capability-based access. Insurance wraps the whole loop. When grain is delivered, payment flows back automatically through the waterfall.
          </p>
